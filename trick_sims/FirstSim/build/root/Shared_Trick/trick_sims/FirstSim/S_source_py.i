%module m02f6b5bb52bf319dfe0fa8bf2cbbf84b
...
%{
#include "/root/Shared_Trick/trick_sims/FirstSim/S_source.hh"
%}
...
%import "build/root/Shared_Trick/trick_sims/FirstSim/models/ball/include/rocket_analytic_py.i"
...
class RocketSimObject : public Trick::SimObject {
    ...
    public:
        ...
        RocketSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "rocket_default_data", "", 60000) ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "rocket_init", "", 60000) ;
            job = this->add_job(0, 2, "scheduled", NULL, 0.01, "rocket_analytic", "", 60000) ;
            job = this->add_job(0, 3, "shutdown", NULL, 1, "rocket_shutdown", "", 60000) ;
        }
