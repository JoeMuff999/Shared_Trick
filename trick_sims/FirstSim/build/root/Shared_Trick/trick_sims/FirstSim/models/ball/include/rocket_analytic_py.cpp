...
/*-----------------------------------------------
              @(target):= _me1e67967e8035ed4a8ef037c1d62200e.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__me1e67967e8035ed4a8ef037c1d62200e

#else
#  define SWIG_init    init_me1e67967e8035ed4a8ef037c1d62200e

#endif
#define SWIG_name    "_me1e67967e8035ed4a8ef037c1d62200e"
...
SWIGINTERN PyObject *_wrap_rocket_analytic(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ROCKET *arg1 = (ROCKET *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:rocket_analytic",&obj0)) SWIG_fail;
  {
    // ROCKET *
    void * temp_ptr ;
  ...
  result = (int)rocket_analytic(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "rocket_analytic" ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"rocket_analytic", _wrap_rocket_analytic, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
