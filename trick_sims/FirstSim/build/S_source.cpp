...
/* Created 2018/11/21 12:42:07 root $ */
#include "../S_source.hh"
...
int RocketSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            rocket_default_data( &rocket ) ;
            break ;
        case 1:
            rocket_init( &rocket ) ;
            break ;
        case 2:
            rocket_analytic( &rocket ) ;
            break ;
        case 3:
            rocket_shutdown( &rocket ) ;
            break ;
        default:
            trick_ret = -1 ;
            break ;
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 17.4.dev, Wed Nov 21 12:42:07 2018" ) ;
    exec_set_build_date( "Wed Nov 21 12:42:07 2018" ) ;
