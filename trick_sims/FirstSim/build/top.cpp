...
#define SWIGTYPE_p_DMTCPSimObject swig_types[8]
#define SWIGTYPE_p_DataRecordDispatcherSimObject swig_types[9]
#define SWIGTYPE_p_ENUM_ATTR swig_types[10]
#define SWIGTYPE_p_ENUM_LIST swig_types[11]
#define SWIGTYPE_p_EQUIV_ATTRIBUTES swig_types[12]
#define SWIGTYPE_p_EventManagerSimObject swig_types[13]
#define SWIGTYPE_p_FrameLogSimObject swig_types[14]
#define SWIGTYPE_p_INDEX swig_types[15]
...
#define SWIGTYPE_p_ROCKET swig_types[32]
#define SWIGTYPE_p_RTSyncSimObject swig_types[33]
#define SWIGTYPE_p_RocketSimObject swig_types[34]
#define SWIGTYPE_p_SEND_ME swig_types[35]
#define SWIGTYPE_p_SIM_COMMAND swig_types[36]
#define SWIGTYPE_p_SIM_MODE swig_types[37]
#define SWIGTYPE_p_SieSimObject swig_types[38]
#define SWIGTYPE_p_SimObjectVector swig_types[39]
#define SWIGTYPE_p_SysSimObject swig_types[40]
#define SWIGTYPE_p_TCCommBlocking swig_types[41]
#define SWIGTYPE_p_TCCommFlag swig_types[42]
#define SWIGTYPE_p_TCDevice swig_types[43]
#define SWIGTYPE_p_TIME_OFFSET swig_types[44]
#define SWIGTYPE_p_TRICK_ALLOC_TYPE swig_types[45]
#define SWIGTYPE_p_TRICK_STCL swig_types[46]
#define SWIGTYPE_p_TRICK_TYPE swig_types[47]
#define SWIGTYPE_p_TSMDevice swig_types[48]
#define SWIGTYPE_p_TagsIterator swig_types[49]
#define SWIGTYPE_p_TrickErrorLevel swig_types[50]
#define SWIGTYPE_p_Trick__MSSharedMemData swig_types[51]
#define SWIGTYPE_p_Trick__MonteVarCalculated swig_types[52]
#define SWIGTYPE_p_Trick__MonteVarFile swig_types[53]
#define SWIGTYPE_p_Trick__MonteVarFixed swig_types[54]
#define SWIGTYPE_p_Trick__MonteVarRandom swig_types[55]
#define SWIGTYPE_p_Trick__VarNameElement swig_types[56]
#define SWIGTYPE_p_Trick__VarNameElementType swig_types[57]
#define SWIGTYPE_p_UdUnitsSimObject swig_types[58]
#define SWIGTYPE_p_UnitTestSimObject swig_types[59]
#define SWIGTYPE_p_VALUE swig_types[60]
#define SWIGTYPE_p_VALUE_LIST swig_types[61]
#define SWIGTYPE_p_VAR_DECLARE swig_types[62]
#define SWIGTYPE_p_VAR_LIST swig_types[63]
#define SWIGTYPE_p_VS_COPY_MODE swig_types[64]
...
#define SWIGTYPE_p_const_reference swig_types[74]
...
SWIGINTERN int Swig_var_trick_dmtcp_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_DMTCPSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_dmtcp""' of type '""DMTCPSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_dmtcp""' of type '""DMTCPSimObject""'");
    } else {
      DMTCPSimObject * temp;
      temp  = reinterpret_cast< DMTCPSimObject * >(argp);
      trick_dmtcp = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_dmtcp_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_dmtcp), SWIGTYPE_p_DMTCPSimObject,  0 );
  return pyobj;
}
...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_sys",Swig_var_trick_sys_get, Swig_var_trick_sys_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_mc",Swig_var_trick_mc_get, Swig_var_trick_mc_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_mm",Swig_var_trick_mm_get, Swig_var_trick_mm_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_cpr",Swig_var_trick_cpr_get, Swig_var_trick_cpr_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_sie",Swig_var_trick_sie_get, Swig_var_trick_sie_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_cmd_args",Swig_var_trick_cmd_args_get, Swig_var_trick_cmd_args_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_message",Swig_var_trick_message_get, Swig_var_trick_message_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_jit",Swig_var_trick_jit_get, Swig_var_trick_jit_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_ip",Swig_var_trick_ip_get, Swig_var_trick_ip_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_em",Swig_var_trick_em_get, Swig_var_trick_em_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_vs",Swig_var_trick_vs_get, Swig_var_trick_vs_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_data_record",Swig_var_trick_data_record_get, Swig_var_trick_data_record_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_real_time",Swig_var_trick_real_time_get, Swig_var_trick_real_time_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_frame_log",Swig_var_trick_frame_log_get, Swig_var_trick_frame_log_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_master_slave",Swig_var_trick_master_slave_get, Swig_var_trick_master_slave_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_instruments",Swig_var_trick_instruments_get, Swig_var_trick_instruments_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_dmtcp",Swig_var_trick_dmtcp_get, Swig_var_trick_dmtcp_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_inject",Swig_var_trick_inject_get, Swig_var_trick_inject_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_zero_conf",Swig_var_trick_zero_conf_get, Swig_var_trick_zero_conf_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_utest",Swig_var_trick_utest_get, Swig_var_trick_utest_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"trick_udunits",Swig_var_trick_udunits_get, Swig_var_trick_udunits_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"dyn",Swig_var_dyn_get, Swig_var_dyn_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
